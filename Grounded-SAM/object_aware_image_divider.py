...
class ObjectAwareImageDivider:
    ...
    GROUNDING_DINO_CHECKPOINT_FILE = "groundingdino_swinb_cogcoor.pth"
...
if __name__ == "__main__":
    object_aware_image_divider = ObjectAwareImageDivider(superRes=True)
    object_of_interest = "sea shell"
    question = "How many birds are there on the right signal?"

    # object_aware_image_divider.divide_by_prompt(
    #     image_path="/home/muhammad/ghofrani-workspace/visual-reasoning/Grounded-SAM/tmp_06.09.2024-11:32:34/3322.jpg/3322_crops/3322_crop_1.png",
    #     prompt="green pea",
    #     output_folder="output",
    #     vertical_divides=2,
    #     horizontal_divides=1,
    # )
    object_aware_image_divider.detect_area(
        image_path="/home/muhammad/ghofrani-workspace/visual-reasoning/Grounded-SAM/data/fsc-147/images_384_VarV2/2.jpg",
        # prompt=f"a group of {object_of_interest}s. {object_of_interest}s. {object_of_interest}",
