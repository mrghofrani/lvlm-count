...
parser.add_argument('--number_of_vertical_divides', type=int, default=2, required=False)
parser.add_argument('--number_of_horizontal_divides', type=int, default=2, required=False)
